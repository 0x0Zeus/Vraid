...
const MarketCard = (
  ...
  const { event, market, setMarket } = useEventContext();
        ...
        <Tabs defaultValue="buy" className="">
          <div className="border-b border-[#d9d9d9]/30 px-7 flex items-end justify-between">
            <TabsList className="bg-transparent space-x-5">
              <TabsTrigger value="buy" onClick={() => setMarket('buy')} className="hover:text-[#ff4500] cursor-pointer data-[state=active]:text-[#ff4500] px-0 text-lg border-b hover:border-[#ff4500] data-[state=active]:border-[#ff4500] transitaion-all duration-300 ease-initial">
                Buy
              </TabsTrigger>
              <TabsTrigger value="sell" onClick={() => setMarket('sell')} className="hover:text-[#ff4500] cursor-pointer data-[state=active]:text-[#ff4500] px-0 text-lg border-b hover:border-[#ff4500] data-[state=active]:border-[#ff4500] transitaion-all duration-300 ease-initial">
                Sell
              </TabsTrigger>
            </TabsList>
